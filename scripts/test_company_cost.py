"""
Test script for company cost data extraction
"""
import sys
...
# Test file path
test_file = project_root / "data" / "raw" / "Company_Cost - adding month.csv"
...
if test_file.exists():
    ...
    print("Please place 'Company_Cost - adding month.csv' in data/raw/ directory")