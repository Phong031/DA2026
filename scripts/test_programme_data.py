"""
Test script for programme data extraction
"""
import sys
...
# Test file path
test_file = project_root / "data" / "raw" / "programme data - adding month.xlsx"
...
if test_file.exists():
    ...
    print("Please place 'programme data - adding month.xlsx' in data/raw/ directory")