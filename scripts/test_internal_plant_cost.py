"""
Test script for internal plant cost data extraction
"""
import sys
...
# Test file path
test_file = project_root / "data" / "raw" / "Internal_Plant_Cost - adding month.csv"
...
if test_file.exists():
    ...
    print("Please place 'Internal_Plant_Cost - adding month.csv' in data/raw/ directory")